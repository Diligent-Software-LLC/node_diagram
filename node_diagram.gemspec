require_relative './lib/node_diagram/version'

Gem::Specification.new do |spec|

  # Required attributes.
  spec.name                  = "node_diagram"
  spec.version               = NodeDiagramLibrary::VERSION
  spec.authors               = ["Diligent Software LLC"]
  spec.email                 = ["contact@diligentsoftware.org"]
  spec.summary               = %q{A NodeDiagram library. Organizes the
NodeDiagram components.}
  spec.description           = %q{A NodeDiagram library. Organizes the
NodeDiagram components. Donations support continuous improvement and
...
available at $1, $2, $4, $8, and $16. Greatly appreciated.}
  ...
  spec.metadata['source_code_uri'] =
      "https://github.com/Diligent-Software-LLC/node_diagram"
